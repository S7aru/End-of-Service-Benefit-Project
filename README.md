...
IAS-19 using the **Projected Unit Credit (PUC)** actuarial method in R. [To download the Excel model click here](https://raw.githubusercontent.com/S7aru/End-of-Service-Benefit-Project/main/model.xlsx)
